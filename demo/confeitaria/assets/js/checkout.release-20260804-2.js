...
export function setupCheckout(config){
  const form=qs('[data-checkout-form]');const deliveryBox=qs('[data-delivery-options]');const addressFields=qs('[data-address-fields]');const fallback=qs('[data-whatsapp-fallback]');const submitButton=qs('[data-submit-order]');
