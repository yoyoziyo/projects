...
import {applyConfig,renderCatalog,money} from './render.release-20260804-1.js';
import {setupCheckout,updateCheckoutSummary} from './checkout.release-20260804-1.js';

const qs=selector=>document.querySelector(selector);let config;let toastTimer;
const resources={
  config:new URL('../../data/config.release-20260803-4.json',import.meta.url),
