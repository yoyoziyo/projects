...
applyConfig(config);renderCatalog(catalog,config,product=>{addItem(product);openDrawer('cart');const badge=qs('[data-cart-count]');badge.classList.remove('bump');requestAnimationFrame(()=>badge.classList.add('bump'))});setupCheckout(config);
